...
public class NonSortedCombinationNumbers implements Comparable<NonSortedCombinationNumbers>, Serializable, Iterable<Integer>{
    private final ArrayList<Integer> indexesWhereAppeared = new ArrayList<>();
    private final Integer[] numbers;

    public NonSortedCombinationNumbers(Integer firstNumber) {
        this.numbers = new Integer[1];
        this.numbers[0] = firstNumber;
    }

    public NonSortedCombinationNumbers(Integer firstNumber, Integer secondNumber) {
        this.numbers = new Integer[2];
        this.numbers[0] = firstNumber;
        this.numbers[1] = secondNumber;
    }

    public NonSortedCombinationNumbers(Integer firstNumber, Integer secondNumber, Integer thirdNumber) {
    ...
    public NonSortedCombinationNumbers(Integer firstNumber, Integer secondNumber, Integer thirdNumber, Integer fourthNumber) {
    ...
    public boolean equals(Object o) {
        ...
        NonSortedCombinationNumbers integers = (NonSortedCombinationNumbers) o;
    ...
    @Override
    public int compareTo(NonSortedCombinationNumbers o) {
        if (numbers.length == 1) {
